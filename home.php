...
body {
  background: linear-gradient(to bottom,rgb(188, 202, 202) 23%,rgb(171, 165, 173) 95%);
}
header {
  position: fixed;
  top: 0;
...
*Grow into the person you want to be with your optional Premium Suite.</p>
    ...
    <section class="services" id="services">
      ...
      <h1>Benefits of joining us through Online.</h1>
      <ul class="cards">
        <li class="card">
          <img src="https://media.gettyimages.com/id/1326217843/photo/shot-of-a-young-women-telemarketer-and-it-support-worker-working-at-home-stock-photo.jpg?s=612x612&w=gi&k=20&c=eNoWK-G2D-AdS2EURq7nQRQImt0NNG9ydFQ0YxTpJR4=" alt="img">
        ...
        <li class="card">
          <img src="https://c8.alamy.com/comp/RB2ET9/knowledge-skills-experience-word-cloud-hand-sphere-concept-on-white-background-RB2ET9.jpg" alt="img">
        ...
        <li class="card">
          <img src="https://media.istockphoto.com/id/684837884/photo/quality-content.jpg?s=612x612&w=0&k=20&c=yhXZqxpsLRny_VXejnlWm2iqDTGkfbAEBCR0GEMYLDY=" alt="img">
          <h3>Quality Conetent</h3>
          <p>Sequencing, cuing, <b>hands-on</b> adjustments & assists, <b>modifications</b>, trauma-informed techniques & inclusive language</p>
        </li>
        <li class="card">
          <img src="https://media.istockphoto.com/id/1290230573/photo/unhappy-young-caucasian-woman-feeling-stressed-about-lack-of-money.jpg?s=612x612&w=0&k=20&c=LvVuaCM8JhZtubBD8HOy7Zb3mdnTaGDqItjS3F0mWGY=" alt="img">
          <h3>Stress Relief:</h3>
        ...
        <li class="card">
          <img src="https://media.istockphoto.com/id/939803700/photo/woman-practicing-yoga-revolved-head-to-knee-pose-parivrtta-janu-sirsasana.jpg?s=612x612&w=0&k=20&c=Mg2FtWPf-sapOury57cCbCLmbDvkwHmXKD2aKQRTsFk=" alt="img">
        ...
        <li class="card">
          <img src="https://www.shutterstock.com/shutterstock/photos/2313692517/display_1500/stock-vector-illustrations-promoting-wellness-mindfulness-and-self-care-happy-woman-feel-confident-relax-2313692517.jpg" alt="img">
